	...
	config := &Config{
		Business: BusinessConfig{
			...
			DomesticWire: DomesticWire{
				Enabled:         getEnvBool("WIRE_DOMESTIC_ENABLED", false),
				BeneficiaryName: getEnv("WIRE_DOMESTIC_BENEFICIARY", ""),
				BankName:        getEnv("WIRE_DOMESTIC_BANK_NAME", ""),
			...
			InternationalWire: InternationalWire{
				...
				BeneficiaryName:    getEnv("WIRE_INTL_BENEFICIARY", ""),
				BeneficiaryAddress: getEnv("WIRE_INTL_BENEFICIARY_ADDRESS", ""),
				BankName:           getEnv("WIRE_INTL_BANK_NAME", ""),
				BankAddress:        getEnv("WIRE_INTL_BANK_ADDRESS", ""),
				SWIFT:              getEnv("WIRE_INTL_SWIFT", ""),
				IBAN:               getEnv("WIRE_INTL_IBAN", ""),
