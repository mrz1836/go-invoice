	...
	return &MCPTool{
		...
		Examples: []MCPToolExample{
			...
			},
			{
				...
				Input: map[string]interface{}{
					"batch_invoices": []string{exampleInvoiceID, "INV-002", "INV-003"},
					fieldTemplate:    "minimal",
				},
		...
		CLIArgs:    []string{"generate", fieldInvoice},
		...
		Examples: []MCPToolExample{
			{
				...
				Input: map[string]interface{}{
					...
					"include_charts": true,
					fieldFormat:      "html",
					fieldOutputPath:  "./reports/august-2025-summary.html",
				},
			...
			},
			{
				...
				Input: map[string]interface{}{
					...
					"show_trends":     true,
					fieldFormat:       "pdf",
					fieldOutputPath:   "./client-reports/acme-corp-ytd-2025.pdf",
				},
			...
			},
			{
				...
				Input: map[string]interface{}{
					...
					"include_details": true,
					fieldFormat:       "csv",
					fieldOutputPath:   "./collections/overdue-summary.csv",
				},
			...
			},
			{
				...
				Input: map[string]interface{}{
					...
					fieldFormat:       "excel",
					fieldOutputPath:   "./tax-reports/2025-tax-summary.xlsx",
				},
		...
		Examples: []MCPToolExample{
			{
				...
				Input: map[string]interface{}{
					...
					fieldFormat:     "csv",
					"include_items": true,
					fieldOutputPath: "./exports/paid-invoices-2025.csv",
				},
			...
			},
			{
				...
				Input: map[string]interface{}{
					...
					fieldFormat:     "excel",
					"include_stats": true,
					fieldOutputPath: "./exports/client-database.xlsx",
				},
			...
			},
			{
				...
				Input: map[string]interface{}{
					...
					fieldFormat:     typeJSON,
					"include_rates": true,
					fieldOutputPath: "./analytics/work-items-ytd.json",
				},
			...
			},
			{
				...
				Input: map[string]interface{}{
					...
					fieldOutputPath:    "./client-exports/techsolutions-q1-2025.xml",
				},
			...
			},
			{
				...
				Input: map[string]interface{}{
					...
					fieldFormat:     typeJSON,
					"include_stats": true,
					fieldOutputPath: "./backups/invoice-backup-2025-08.json.gz",
				},
